...
export function WeeklyActivitySlide({ data }: WeeklyActivitySlideProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center md:justify-start p-4 md:p-6 bg-background relative">
      <div className="max-w-4xl w-full h-screen flex flex-col items-center justify-center lg:justify-center pt-16 md:pt-12 gap-6 md:gap-10">
        {/* Section header */}
        <motion.div
        ...
        <motion.div
          ...
          className="md:w-full w-[90%] h-[60dvh] aspect-[4/5] md:aspect-[16/9] max-h-[60dvh] 
          md:max-h-[500px] bg-card/80 mb-15 rounded-[2rem] border border-border/40 
          p-6 md:p-16 flex flex-col items-center shadow-lg relative"
        >
