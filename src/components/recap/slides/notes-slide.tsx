...
function NoteCard({ note, index }: { note: CommentaryNote; index: number }) {
    const emoji = note.emoji || categoryEmojis[note.category] || '✨';
...
export function NotesSlide({ data }: NotesSlideProps) {
    ...
    return (
        <div className="h-full flex flex-col justify-center pt-24 pb-20 px-4">
            ...
            >
                <h2 className="text-3xl md:text-4xl font-bold mb-3">AI Insights</h2>
            ...
            {notes.length > 0 ? (
                ...
                >
                    <p>No AI insights available for this recap.</p>
                </motion.div>
            )}
