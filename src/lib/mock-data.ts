...
import type { RecapData, ContributionWeek, ContributionDay } from '@/types';

function generateContributionCalendar(year: number): { totalContributions: number; weeks: ContributionWeek[]; months: { name: string; firstDay: string; totalWeeks: number }[] } {
