...
import type { ContributionCalendar, ContributionWeek, ContributionDay } from '../../src/types';
...
export async function generateOGImage(props: OGImageProps): Promise<Buffer> {
    ...
    // Load branding SVG
    // Try recap_icon_{year}.svg first, then recap_logo_{year}.svg
    ...
    // SVG Icons for cards
    const icons = {
        contributions: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h.01"/><path d="M7 20h.01"/><path d="M17 20h.01"/><path d="M12 16h.01"/><path d="M7 16h.01"/><path d="M17 16h.01"/><path d="M12 12h.01"/><path d="M7 12h.01"/><path d="M17 12h.01"/><path d="M12 8h.01"/><path d="M7 8h.01"/><path d="M17 8h.01"/><path d="M12 4h.01"/><path d="M7 4h.01"/><path d="M17 4h.01"/></svg>`,
        streak: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f0883e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.5 3.5 6.5 1 1.5 2 3.5 2 5a6.5 6.5 0 1 1-13 0c0-1.012.394-2.106 1-3l3 3Z"/></svg>`,
        repos: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/></svg>`,
        prs: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M13 6h3a2 2 0 0 1 2 2v7"/><line x1="6" y1="9" x2="6" y2="21"/></svg>`,
        language: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>`,
        stars: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e3b341" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`
    };

    const statCard = (icon: string, label: string, value: string | number, color: string = '#8b949e', flex: number = 1) => ({
        type: 'div',
        props: {
            style: {
                display: 'flex',
            ...
            children: [
                {
                    ...
                    props: {
                        ...
                        children: [
                            { type: 'div', props: { dangerouslySetInnerHTML: { __html: icon }, style: { display: 'flex', color: color } } },
                            ...
                            children: [
                                ...
                                brandingSvg ? {
                                    ...
                                    props: {
                                        ...
                                        dangerouslySetInnerHTML: { __html: brandingSvg }
                                    }
                                } : {
                                    type: 'div',
                                    props: {
